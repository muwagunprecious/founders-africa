...
import type { ProgramData } from "../_data";
import { useWaitlistModal } from "@/context/WaitlistContext";

export default function ProgramClientPage({ programme }: { programme: ProgramData }) {
          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
              <button
                ...
                className="inline-flex items-center justify-center rounded-xl bg-primary px-6 py-3.5 text-sm font-medium text-black hover:brightness-110 sm:px-8 sm:py-4 sm:text-base cursor-pointer"
              >
                {programme.heroCta}
              </button>
          ...
          {/* <aside className="h-fit lg:sticky lg:top-28" id="application">
            <div className="rounded-2xl border border-black/10 bg-white p-6 shadow-[0_18px_50px_rgba(13,17,23,0.08)]">
              ...
              <div className="mt-6 rounded-2xl bg-[#f6faea] p-5">
                ...
                <button
                  onClick={openWaitlistModal}
                  className="mt-5 inline-flex w-full items-center justify-center rounded-xl bg-primary px-5 py-3.5 text-sm font-medium text-black hover:brightness-110 cursor-pointer"
                >
                  Apply Now
                </button>
